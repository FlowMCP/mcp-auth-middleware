...
const config = {
    ...
    silent: true,
    // OAuth endpoints for single-realm backwards compatibility
    authorizationEndpoint: 'https://your-first-auth0-domain.auth0.com/authorize',
    tokenEndpoint: 'https://your-first-auth0-domain.auth0.com/oauth/token',
    deviceAuthorizationEndpoint: 'https://your-first-auth0-domain.auth0.com/oauth/device/code'
}
...
const testRealmsByRoute = {
    '/api/v1': {
        ...
        // OAuth endpoints generated by OAuth21Auth0Provider
        authorizationUrl: `${config.providerUrl}/authorize`,
        tokenUrl: `${config.providerUrl}/oauth/token`,
        deviceAuthorizationUrl: `${config.providerUrl}/oauth/device/code`,
    ...
    '/admin': {
        ...
        // OAuth endpoints generated by OAuth21Auth0Provider
        authorizationUrl: 'https://another-domain.auth0.com/authorize',
        tokenUrl: 'https://another-domain.auth0.com/oauth/token',
        deviceAuthorizationUrl: 'https://another-domain.auth0.com/oauth/device/code',
        authorizationEndpoint: 'https://another-domain.auth0.com/authorize',
        tokenEndpoint: 'https://another-domain.auth0.com/oauth/token',
        deviceAuthorizationEndpoint: 'https://another-domain.auth0.com/oauth/device/code'
    }
}
    ...
    describe( 'create', () => {
        ...
        test( 'configures Auth0 endpoints correctly for single realm', () => {
            handler = OAuthFlowHandler.create( {
                ...
                redirectUri: 'http://localhost:3000/callback',
                silent: true,
                // In real usage, these would be provided by AuthTypeFactory
